...
const translations = {
  ua: {
    ...
    'admin.listTitle': 'Мої товари', 'admin.empty': 'Поки що немає доданих товарів. Натисніть «+ Додати товар».',
  ...
  en: {
    ...
    'admin.listTitle': 'My products', 'admin.empty': 'No products yet. Click "+ Add product".',
